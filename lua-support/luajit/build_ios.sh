...
make clean
ISDKF="-arch x86_64 -isysroot $SIMDIR/SDKs/$SIMVER -miphoneos-version-min=5.0  -fembed-bitcode-marker"
...
make clean
ISDKF="-arch i386 -isysroot $SIMDIR/SDKs/$SIMVER -miphoneos-version-min=5.0  -fembed-bitcode-marker"
